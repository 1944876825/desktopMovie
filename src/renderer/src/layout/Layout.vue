  ...
  <div style="height: 100%;">
    <el-container style="height: 100%;">
      ...
      <el-aside class="flex-col" style="height: 100%;width: 64px;">
        <el-row style="width: 64px;background-color: rgb(30, 32, 34);height: 80px;" align="middle" justify="center">
          <el-avatar class="hand" :size="40" src="https://q1.qlogo.cn/g?b=qq&nk=1944876825&s=640" />
        </el-row>
        <el-menu default-active="home" class="flex-1" :collapse="true" text-color="#fff"
                 active-text-color="#FB7299" style="height: 90%;background-color: rgb(30, 32, 34);border-right: 0;"
                 router>
      ...
      <el-container>
        <el-header
            ...
            style="background-color: rgb(23, 24 ,26); height: 80px; border-bottom: 1px solid rgb(35, 37, 39);overflow: hidden;">
          <el-row style="height: 100%;" align="middle" justify="space-between">
            <el-row align="middle" style="height: 100%;">
              <div class="main-text-color" style="font-size: 24px;font-weight: 600;">
                旧梦影视
              </div>
              <div class="no-drag" v-if="searchinput && cateList.length>0" style="padding-left: 50px;padding-top: 10px;">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                  <el-tab-pane v-for="cate in cateList" :label="cate.title" :name="cate.id"></el-tab-pane>
                </el-tabs>
              </div>
            </el-row>
            ...
            <el-row align="middle">
              <div class="no-drag" style="padding: 0 30px;">
                <el-input @fouse="searchinput=false" @blur="searchinput=true" class="searchinput" @click="handleSearch" size="large" placeholder="搜索你感兴趣的视频" />
              </div>
              <el-row align="middle" class="no-drag" style="display:none;">
        ...
        <el-main>
          <router-view :activeName="activeName" />
        </el-main>
      </el-container>
